...
question_list = []
question_list.append(Question("Сколько людей проживает в волгограде ?","1,019 миллиона ","0","2","1"))
question_list.append(Question("Сколько население Москвы 2020?","12 678 079 человек","1","3","2"))
question_list.append(Question("Когда открыли Америку","12 октября 1492 года","12","35476","12"))
